...
<div id="wrapper">
    ...
    <fieldset>
		<legend>Product Details: Product <?php echo $x ?></legend>
			<div><label for="productname<?php echo $x ?>">Product Name</label> <input id="productname<?php echo $x ?>"
                                                                                      name="productname<?php echo $x ?>" value="" /></div>
			...
			<div><label for="productprice<?php echo $x ?>">Product Price</label> $<input id="productprice<?php echo $x ?>" name="productprice<?php echo $x ?>" size="10" /></div>
	</fieldset>
